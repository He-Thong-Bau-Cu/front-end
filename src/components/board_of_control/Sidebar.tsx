...
const Sideber: React.FC<SideberProps> = ({ onMenuSelect }) => {
  ...
  const menuItems = [
    ...
    {
      key: "/board-of-control/confirmed-elections-from-secretary",
      icon: <UserSwitchOutlined />,
      label: "Bầu cử đã xác nhận từ thư ký",
    },
    {
    ...
    (item) =>
      permissions.includes(item.key) || permissionsElections.includes(item.key)
  );

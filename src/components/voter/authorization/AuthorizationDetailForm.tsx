...
interface AuthorizationDetailFormProps {
    selectedUser: User;
    onBack: () => void;
}

const AuthorizationDetailForm = ({ selectedUser, onBack }: AuthorizationDetailFormProps) => (
    <Card
...
export default AuthorizationDetailForm;

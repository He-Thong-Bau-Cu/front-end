          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div>
              {meetingInfo.meetingDate
                ? (() => { const date = new Date(meetingInfo.meetingDate); const h = String(date.getHours()).padStart(2, '0'); const m = String(date.getMinutes()).padStart(2, '0'); const day = String(date.getDate()).padStart(2, '0'); const month = String(date.getMonth() + 1).padStart(2, '0'); const year = date.getFullYear(); return `${h}:${m} ${day}/${month}/${year}`; })()
                : "Chưa cập nhật"}
            </div>
          </div>
          <div style={{ flex: 1, minWidth: 0 }}>
